...
export function activate(context: vscode.ExtensionContext) {
    console.log('Claude Code Sidebar extension is now active');

    // Register the webview view provider
    const provider = new ClaudeCodeViewProvider(context.extensionUri);
...
export function deactivate() {
    console.log('Claude Code Sidebar extension is being deactivated');
    if (ptyProcess) {
        console.log('Terminating Claude terminal...');
        ptyProcess.kill();
        ptyProcess = undefined;
    }
}

class ClaudeCodeViewProvider implements vscode.WebviewViewProvider {
